...
| P6 双语 + CI 金图 + ESP32 冒烟 + 发布 | ⏳ 金图 ✅ / Win 构建 ✅ / 单 exe 无 DLL ✅; 余 ESP32 冒烟 + Win 体积口径 | 体积: **SDL 版 144KB / 英文版 143KB ✅ 达标 ≤150KB**(gold `--icf=all`+`--as-needed`); sokol 版 361KB(含 vendored sokol, 独立口径) |
